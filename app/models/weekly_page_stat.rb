...
# Indexes
#
#  idx_weekly_page_stats_dimension_type  (dimension_type)
#  idx_weekly_page_stats_site_host_week  (site_id,hostname,week_start)
#  idx_weekly_page_stats_site_week       (site_id,week_start)
#  idx_weekly_page_stats_unique          (site_id,hostname,pathname,dimension_type,dimension_value,week_start) UNIQUE
