...
ActiveRecord::Schema[8.1].define(version: 2026_04_07_110940) do
  ...
  create_table "daily_page_stats", force: :cascade do |t|
    ...
    t.index ["site_id", "hostname", "pathname", "date"], name: "idx_daily_page_stats_unique", unique: true
  ...
  create_table "hourly_page_stats", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.integer "visits", default: 0, null: false
    t.index ["site_id", "hostname", "pathname", "time_bucket"], name: "idx_hourly_page_stats_unique", unique: true
  ...
  create_table "weekly_page_stats", force: :cascade do |t|
    ...
    t.index ["site_id", "hostname", "pathname", "week_start"], name: "idx_weekly_page_stats_unique", unique: true
