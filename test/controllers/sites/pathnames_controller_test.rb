...
module Sites
  class PathnamesControllerTest < ActionDispatch::IntegrationTest
    ...
    test "aggregates stats by pathname" do
       login(users(:alice))
       create_daily_stat(sites(:tech_blog))
       create_daily_stat(sites(:tech_blog), pathname: "/about", pageviews: 50, unique_pageviews: 30, visits: 25, sessions: 20, bounced_count: 10, total_duration: 60.0, duration_count: 20)
    ...
    test "displays pathname stats with hourly interval" do
       login(users(:alice))
       create_hourly_stat(sites(:tech_blog))
    ...
    test "displays pathname stats with weekly interval" do
       login(users(:alice))
       create_weekly_stat(sites(:tech_blog))
    ...
    test "sorts pathnames by pageviews descending" do
       login(users(:alice))
       create_daily_stat(sites(:tech_blog), pathname: "/low", pageviews: 10, unique_pageviews: 5, visits: 4, sessions: 3, bounced_count: 2, total_duration: 30.0, duration_count: 3)
       create_daily_stat(sites(:tech_blog), pathname: "/high", pageviews: 100)
    ...
    test "calculates bounce rate correctly" do
       login(users(:alice))
       create_daily_stat(sites(:tech_blog), bounced_count: 50)
    ...
    test "calculates avg duration correctly" do
       login(users(:alice))
       create_daily_stat(sites(:tech_blog), total_duration: 120.0, duration_count: 10)
    ...
    test "handles pagination" do
       ...
       25.times do |i|
         create_daily_stat(sites(:tech_blog), pathname: "/page-#{i}", pageviews: 100 - i)
       end
    ...
    test "groups stats by hostname and pathname when display_hostname is true" do
       login(users(:alice))
       sites(:tech_blog).update!(display_hostname: true)
       create_daily_stat(sites(:tech_blog), hostname: "app.example.com")
       create_daily_stat(sites(:tech_blog), hostname: "docs.example.com", pageviews: 50, unique_pageviews: 25, visits: 20, sessions: 15, bounced_count: 10, total_duration: 60.0, duration_count: 15)
    ...
    test "returns single row when filtering by pathname" do
       ...
       sites(:tech_blog).update!(display_hostname: false)
       create_daily_stat(sites(:tech_blog))
       create_daily_stat(sites(:tech_blog), pathname: "/about", pageviews: 50, unique_pageviews: 25, visits: 20, sessions: 15, bounced_count: 10, total_duration: 60.0, duration_count: 15)
    ...
    test "filters pathnames by date range when params present" do
       login(users(:alice))
       create_daily_stat(sites(:tech_blog), date: Date.new(2024, 1, 15))
       create_daily_stat(sites(:tech_blog), date: Date.new(2024, 1, 25), pageviews: 60, unique_pageviews: 30, visits: 25, sessions: 20, bounced_count: 12, total_duration: 75.0, duration_count: 20)
